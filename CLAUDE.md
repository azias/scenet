...
- **No `from __future__ import annotations`.** Python 3.14 evaluates annotations lazily (PEP
  649/749); forward references work unquoted and the import is on a deprecation path.
